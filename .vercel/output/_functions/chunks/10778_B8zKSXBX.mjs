const id = "10778.md";
						...
						const data = {title:"Estudiantes de Periodoncia de Unicoc Cali fortalecen su formación con movilidad internacional en Chile y España.",date:new Date(1733011200000),heroImage:"https://www.unicoc.edu.co/img/cargas/Noticias/2024/12/2024-12-2-10778.png"};
						const _internal = {
							type: 'content',
							filePath: "/home/michi/dev/web/unicoc-landing/src/content/news/10778.md",
							rawData: undefined,
						};
